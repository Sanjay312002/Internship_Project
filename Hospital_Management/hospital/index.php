...
<?php
include_once('sh/include/config.php');
...
<head>
    ...
    <title> Sanjeevan Hospital</title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;"><img src="./assets/images/sh.webp" style="max-width:68px" alt="">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="sh/user-login.php">Book an Appointment</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown"> Sanjeevan Hospital</h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="sh/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="sh/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                ...
                <h2 >Book Appointment</h2>
                    ...
                    <div  class="row cf-ro">
                     ...
                     <div  class="row cf-ro">
                        ...
                        <div class="col-sm-8"><input type="text"  pattern="^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}$" name="mobileno" placeholder="Enter Mobile Number" class="form-control input-sm"  required ></div>
                    </div>
                     <div  class="row cf-ro">
                     ...
                     <div  class="row cf-ro">
                        ...
                        <div class="col-sm-8">
                         <button class="btn btn-success btn-sm" type="submit" name="submit">Book Appointment</button>
                        </div>
                </div>
            </form>
            </div>
